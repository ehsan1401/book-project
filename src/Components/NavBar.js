        ...
        <div className="navigationbar">
            <div className="content bg-blue-950 text-white">
                ...
                <ul className="flex p-2 gap-5 box-border ml-10 ">
                    ...
                    <a href="#" className="p-3 font-bold hover:text-blue-500 transition duration-200"><li> aboute us </li></a>
                    <a href="#" className="p-3 font-bold hover:text-blue-500 transition duration-200"><li> home </li></a>
