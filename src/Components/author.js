    ...
    return ( 
        <div className="autors-container w-full h-auto">
            {autors.map((aut)=>{
                if(aut.name === name){
                    return(
                        <div className="autor w-full h-full lg:w-full md:w-full xl:flex sm:grid">
                            {/* <p>{aut.name}</p> */}
                            <div className="autor-details text-left p-5 xl:w-9/12 w-full border-dashed border-2 border-gray-400 m-2 bg-gray-50">
                                ...
                                <div className="aut-info flex h-auto ">
                                    <img src={aut.imageURL} alt={aut.name} className="rounded-2xl h-72 shadow-lg" />
                                    <div className="info-aut mx-10 font-thin">
                                        <p>{aut.fullInfo}</p><br />
