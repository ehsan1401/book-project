...
const UserDashboadrd = () => {
    ...
    return ( 
        <div className="dashboadrd w-full h-screen bg-blue-100">
            {users.map((user)=>{
                if(userID == user.userID){
                    return(
                        <div className="user  w-full h-screen flex p-5 gap-5">
                            <div className="profile w-1/5 border-dashed border-black border-2 p-3 bg-blue-300 rounded-lg shadow-2xl">
                            ...
                            <div className="main-content-dashboard w-4/5 border-solid border-black border-2 bg-blue-300 rounded-lg shadow-2xl box-border relative overflow-scroll p-10">
                                
                                {bookfavorite && <div className="bookfavorite h-full rounded-lg grid grid-cols-4 gap-5">
                                ...
                                {authorfavorite && <div className="authorfavorite  w-full h-full rounded-lg ">Favorite Authors</div>}
                                {changes && <div className="some-ghanges  w-full h-full rounded-lg ">Some Changes</div>}
                                {messages && <div className="some-ghanges  w-full h-full rounded-lg ">Messages</div>}
